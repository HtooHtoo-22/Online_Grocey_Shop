  ...
  <div class="container-lg">
              ...
              <div class="col">
                <div class="product-item">
                  <figure class="product-image-container">
                    <a href="javascript:void(0)" class="nav-link swiper-slide text-center" title="${fav.productName}" onclick="showModal('${fav.id}', '${fav.productName}', '${fav.description}', 'data:image/jpeg;base64,${fav.getBase64()}', ${fav.price}, ${fav.per_quantity}, '${fav.unit}', '${fav.categoryName}', '${fav.quantity}','${fav.productId}','${fav.productUnit}')">
                      <img src="data:/jpeg;base64,${fav.getBase64()}" alt="${fav.productName}" class="tab-image product-img">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">${fav.productName}</h3>
                    <div>
                     
                      <!-- Replace with dynamic review count if available -->
                    </div>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                    <div class="text-dark fw-semibold">${fav.per_quantity} ${fav.unit} /</div>
                      <span class="text-dark fw-semibold">${fav.price} KS</span>
                    </div>
   ...
   <div class="button-container" style="display: flex; align-items: center; justify-content: flex-start;">
    ...
    <button 
        ...
        onclick="addToCartWithQuantity('${fav.id}', '${fav.productName}', ${fav.price}, '${fav.getBase64()}', '${fav.quantity}', '${fav.per_quantity}', '${fav.unit}', '${fav.productUnit}')">
        <svg width="16" height="16"><use xlink:href="#cart"></use></svg> Add to Cart
    </button>

    <!-- Favorite Button -->
<a href="unfavorite?id=${fav.productId}" 
   class="btn btn-outline-dark rounded-1 p-1 fs-6 favorite-button ms-2" 
   style="font-size: 0.75rem; width: 35px; height: 40px; padding: 4px; display: flex; justify-content: center; align-items: center;">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" 
         class="size-6" style="width: 16px; height: 16px;">
