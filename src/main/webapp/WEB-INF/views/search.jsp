 ...
 <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-header d-flex flex-wrap justify-content-between my-4">
          <h2 class="section-title">Not Found The Product "${SearchedWords}"</h2>
...
<c:if test="${not empty SearchedProducts}">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-header d-flex flex-wrap justify-content-between my-4">
          <h2 class="section-title">Searched Products "${SearchedWords}" </h2>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
            ...
            <c:forEach items="${SearchedProducts}" var="search">
              <div class="col">
                <div class="product-item">
                  <figure class="product-image-container">
                    <a href="javascript:void(0)" class="nav-link swiper-slide text-center" title="${search.productName}" onclick="showModal('${search.id}', '${search.productName}', '${search.description}', 'data:image/jpeg;base64,${search.getBase64()}', ${search.price}, ${search.per_quantity}, '${search.unit}', '${search.categoryName}', '${search.quantity}','${search.productId}','${search.productUnit}')">
                      <img src="data:/jpeg;base64,${search.getBase64()}" alt="${search.productName}" class="tab-image product-img">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">${search.productName}</h3>
                    <div>
                      
                      <!-- Replace with dynamic review count if available -->
                    </div>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                    <div class="text-dark fw-semibold">${search.per_quantity} ${search.unit} /</div>
                      <span class="text-dark fw-semibold">${search.price} KS</span>
                    </div>
    ...
    <button 
        ...
        onclick="addToCartWithQuantity('${search.id}', '${search.productName}', ${search.price}, '${search.getBase64()}', '${search.quantity}', '${search.per_quantity}', '${search.unit}', '${search.productUnit}')">
    ...
    <button 
        ...
        data-product-id="${search.productId}" 
